...
<body>
	<div class="content section bg-faded">
						...
						<div class="panel-group" id="accordion">
							<div class="panel panel-default">
								...
								<div id="collapseOne" class="panel-collapse collapse in">
									<ul class="list-group">
										<li class="list-group-item"><i class="fa fa-home text-dark"></i> <a href="{{route('home')}}" class="btn-link">{{__('Beranda')}}</a></li>

										<li class="list-group-item"><i class="fa fa-ticket text-primary"></i> <a href="{{route('user.cari-tiket')}}" class="btn-link">{{__('Cari Tiket')}}</a></li>

										<li class="list-group-item"><i class="fa fa-newspaper-o text-success"></i> <a href="#" class="btn-link">{{__('Berita')}}</a></li>

										<li class="list-group-item"><i class="fa fa-heart text-danger"></i> <a href="{{route('user.my-ticket.all')}}" class="btn-link">{{__('My Ticket')}}</a></li>
									</ul>
								</div>
							</div>
							<div class="panel panel-default">
